...
ldfpath = os.path.join(here, '..','LL1_736_population_spawn_simpler_dataset','tables','learningData.csv')
...
ldf = pd.read_csv(ldfpath, index_col='d3mIndex')
...
for grp in ldf.groupby(['species','sector']):
	...
	test_index.extend(grp[1].tail()[-1:].index.values)
# print(test_index)
# print(ldf_cp.ix[test_index])
